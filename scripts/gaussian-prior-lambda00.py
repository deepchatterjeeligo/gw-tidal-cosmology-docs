...
plt.text(3000, 0.17, "$\Delta z/z$; Gaussian")
plt.text(2000, 0.14, "$\Delta z/z$; Fixed")
plt.text(2000, 0.35, "$\Delta D_L/D_L$; Gaussian")
plt.text(2000, 0.4, "$\Delta D_L/D_L$; Fixed")
plt.text(1000, 0.5, "$\Delta H_0/H_0$; Gaussian")
plt.text(1000, 0.44, "$\Delta H_0/H_0$; Fixed")
plt.tight_layout()
